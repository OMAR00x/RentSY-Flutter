...
class FilterScreen extends StatefulWidget {
  final FilterParams initialFilterParams;
...
class _FilterScreenState extends State<FilterScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<FilterCubit>().setInitialParams(widget.initialFilterParams);
      context.read<FilterCubit>().loadFilterOptions();
    });
  }
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<CityModel>(
          ...
          initialValue:
              currentFilterParams.cityId != null && selectedCity.id != 0
              ? selectedCity
              : null,
        ...
        DropdownButtonFormField<AreaModel>(
          ...
          initialValue:
              currentFilterParams.areaId != null && selectedArea.id != 0
              ? selectedArea
              : null,
  ...
  Widget _buildPriceRange(
    ...
    final double currentMaxPrice = currentFilterParams.maxPrice ?? 5000;
    const double maxPriceLimit = 10000;
    ...
    return Column(
      ...
      children: [
        ...
        RangeSlider(
          ...
          min: 0,
          max: maxPriceLimit,
          divisions: (maxPriceLimit / 100).round(),
          ...
          onChanged: (RangeValues newValues) {
            context.read<FilterCubit>().onPriceRangeChanged(
              newValues.start,
              newValues.end,
            );
          },
  ...
  Widget _buildRoomsSelection(
    ...
    List<int?> roomOptions = [null, 1, 2, 3, 4];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        Wrap(
          ...
          children: roomOptions.map((rooms) {
            ...
            return ChoiceChip(
              label: Text(
                rooms == null ? 'Any' : (rooms == 4 ? '4+' : rooms.toString()),
              ),
              selected: isSelected,
              ...
              onSelected: (selected) {
                context.read<FilterCubit>().onRoomsSelected(
                  selected ? rooms : null,
                );
              },
            );
      ...
      children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final isSelected =
                currentFilterParams.amenityIds?.contains(amenity.id) ?? false;
            return FilterChip(
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.of(
            context,
          ).pop(context.read<FilterCubit>().getAppliedFilterParams);
        },
